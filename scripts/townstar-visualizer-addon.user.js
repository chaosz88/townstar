...
(function() {
    ...
    const setup = {
        ...
        "blueprints": {
            "foundry": {
                "Blueprint_Foundry_Common": {
                    "name": "Blueprint: Thrifty Foundry (Common)",
                    "description": "The Common Blueprint: Thrifty Foundry reduces material by 40% and cash costs by 10% to build the Foundry.",
                    "utility": {
                        "cost": -10,
                        "requirement": -40,
                    },
                },
                "Blueprint_Foundry_Uncommon": {
                    "name": "Blueprint: Thrifty Foundry (Uncommon)",
                    "description": "The Uncommon Blueprint: Thrifty Foundry reduces material costs by 40% and cash costs by 15% to build the Foundry.",
                    "utility": {
                        "cost": -15,
                        "requirement": -40,
                    },
                },
                "Blueprint_Foundry_Rare": {
                    "name": "Blueprint: Thrifty Foundry (Rare)",
                    "description": "The Rare Blueprint: Thrifty Foundry reduces material costs by 40% and cash costs by 20% to build the Foundry.",
                    "utility": {
                        "cost": -20,
                        "requirement": -40,
                    },
                },
                "Blueprint_Foundry_Epic": {
                    "name": "Blueprint: Thrifty Foundry (Epic)",
                    "description": "The Epic Blueprint: Thrifty Foundry reduces material costs by 40% and cash costs by 25% to build the Foundry.",
                    "utility": {
                        "cost": -25,
                        "requirement": -40,
                    },
                },
                "Blueprint_Foundry_Legendary": {
                    "name": "Blueprint: Thrifty Foundry (Legendary)",
                    "description": "The Legendary Blueprint: Thrifty Foundry reduces material costs by 40% and cash costs by 30% to build the Foundry.",
                    "utility": {
                        "cost": -30,
                        "requirement": -40,
                    },
                },
                "Blueprint_Foundry_Platinum": {
                    "name": "Blueprint: Thrifty Foundry (Platinum)",
                    "description": "The Platinum Blueprint: Thrifty Foundry reduces material costs by 40% and cash costs by 35% to build the Foundry.",
                    "utility": {
                        "cost": -35,
                        "requirement": -40,
                    },
                },
                "Blueprint_Foundry_Luxury": {
                    "title": "Blueprint: Thrifty Foundry (Luxury)",
                    "description": "The Luxury Blueprint: Thrifty Foundry reduces material costs by 40% and cash costs by 40% to build the Foundry.",
                    "utility": {
                        "cost": -40,
                        "requirement": -40,
                    },
    ...
    function ShowAppliedUtilities() {
        console.log('appliedUtilities',appliedUtilities);
    ...
    AddCss('.setup-title', 'margin-top: 4px; font-weight: bold;');
    AddCss('#setup-info-container', 'font-weight: bold;');
