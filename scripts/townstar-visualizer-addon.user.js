...
(function() {
    ...
    function EditVisualizer() {
        ...
        const platinumMasterCopperSmith = Object.keys(originalNFTProximityBonuses.Platinum_Master_Copper_Smith);
        function isPlatinumMasterCopperSmith() {
            let valid = false;
            Object.values(grid.grid).forEach(({type: type}) => {
                if (type == "Platinum_Master_Copper_Smith") {
                    valid = true;
                }
            });
