...
(function() {
    ...
    let loadAfterLayoutContainerObserver = new MutationObserver(function(mutations) {
        if (document.querySelector('#info-container') != null) {
            ...
            var contentText = "";
            const txtArea = createEmbedElm("<textarea id=\"display-txtArea\" rows=\"49\" cols=\"33\"></textarea>", "div-display-txtArea", "display-txtArea", contentText, null);
    ...
    AddCss('#calculation-container', 'padding: 5px;');
