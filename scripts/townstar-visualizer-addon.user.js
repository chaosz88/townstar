...
(function() {
    ...
    let loadAfterTsvoperationObserver = new MutationObserver(function(mutations) {
        if (document.querySelector('.TSV_Operation') != null) {
            ...
            layoutTab.id = 'layout-tab';
            layoutTab.classList.add('selected');
            layoutTab.textContent = 'Layout';
            layoutTab.onclick = function() { ShowInfoLayoutContent(); };
            tabContainer.appendChild(layoutTab);

            const calculationTab = document.createElement('div');
            calculationTab.id = 'calculation-tab';
            calculationTab.textContent = 'Calculation';
            calculationTab.onclick = function() { ShowInfoCalculationContent(); };
            tabContainer.appendChild(calculationTab);
            ...
            infoContentContainer.appendChild(layoutContainer);
            ...
            for (const name in recipes) {
                const productName = recipes[name].Name == undefined ? name : recipes[name].Name;
            ...
            */
            ...
            calculationContainer.appendChild(productRateContainer);
            infoContentContainer.appendChild(calculationContainer);
    ...
    AddCss('.categorybutton.selected, #tab-container div.selected', 'border: 0; filter:brightness(150%);');
    ...
    AddCss('#tab-container', 'display: grid; grid-template-columns: repeat(2, 1fr);');
    ...
    AddCss('#calculation-container', 'padding: 4px 32px;');
    ...
    AddCss('#info-content-container', 'overflow: auto;');
    ...
    AddCss('.product-rate-value', 'padding-left: 4px; text-align: right;');
