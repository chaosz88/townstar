...
(function() {
    ...
    AddCss('#northborder, #eastborder, #southborder, #westborder', 'position: relative; display:grid; color: white; user-select: none; background-color: #ccc; text-align: center;');
